          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="alert alert-warning" role="alert">
                <center><font color="red"> <b> บันทึกการเลือกโต๊ะ *ให้พนักงานเลือกให้ เลือกและจองวันต่อวัน </b></font> </center>
              </div>
              <hr>
                  ...
                  <form action="save_booking.php" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                       ...
                       <br>
                       ศึกษาการทำระบบ เพิ่ม ลบ แก้ไข แสดงข้อมูล เพิ่มเติมได้ที่ :
                       <a href="https://www.youtube.com/playlist?list=PLEA4F1w-xYVadrcnedOqksEoOhh4gZfzO" target="_blank">
                        Click
                      </a>
                      </div>
                    </div>
